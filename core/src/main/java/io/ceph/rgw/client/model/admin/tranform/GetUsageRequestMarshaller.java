...
import io.ceph.rgw.client.model.admin.GetUsageRequest;
 ...
 */
public class GetUsageRequestMarshaller extends AdminRequestMarshaller<GetUsageRequest> {
    ...
    public GetUsageRequestMarshaller(AwsXmlProtocolFactory protocolFactory) {
