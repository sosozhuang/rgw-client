...
import io.ceph.rgw.client.model.admin.CreateSubUserRequest;
 ...
 */
public class CreateSubUserRequestMarshaller extends AdminRequestMarshaller<CreateSubUserRequest> {
    ...
    public CreateSubUserRequestMarshaller(AwsXmlProtocolFactory protocolFactory) {
