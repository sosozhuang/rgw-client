...
import io.ceph.rgw.client.model.admin.ModifySubUserRequest;
 ...
 */
public class ModifySubUserRequestMarshaller extends AdminRequestMarshaller<ModifySubUserRequest> {
    ...
    public ModifySubUserRequestMarshaller(AwsXmlProtocolFactory protocolFactory) {
