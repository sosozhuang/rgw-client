 ...
 */
public class AddUserCapabilityRequest extends AdminRequest {
    private static final SdkField<String> UID_FIELD = SdkField
            .builder(MarshallingType.STRING)
            .getter(getter(AddUserCapabilityRequest::getUid))
    ...
    private static final SdkField<String> USER_CAPS_FIELD = SdkField
            .builder(MarshallingType.STRING)
            .getter(getter(AddUserCapabilityRequest::getUserCapsAsString))
    ...
    public AddUserCapabilityRequest(Builder builder) {
        super(builder);
    ...
    private static <T> Function<Object, T> getter(Function<AddUserCapabilityRequest, T> g) {
        return obj -> g.apply((AddUserCapabilityRequest) obj);
    }
    ...
    public String toString() {
        return "AddUserCapabilityRequest{" +
                "uid='" + uid + '\'' +
                ", userCaps=" + userCaps +
                "} " + super.toString();
    }

    public static class Builder extends AdminRequestBuilder<Builder, AddUserCapabilityRequest, AddUserCapabilityResponse> {
        private String uid;
        ...
        private Builder(AddUserCapabilityRequest request) {
            this.userCaps = new LinkedList<>();
            withUid(request.uid);
        ...
        @Override
        public AddUserCapabilityRequest build() {
            return new AddUserCapabilityRequest(this);
        }

        @Override
        public AddUserCapabilityResponse run() {
            return client.addUserCapability(build());
        }

        @Override
        public ActionFuture<AddUserCapabilityResponse> execute() {
            return client.addUserCapabilityAsync(build());
        }

        @Override
        public void execute(ActionListener<AddUserCapabilityResponse> listener) {
            client.addUserCapabilityAsync(build(), listener);
        }
    }
}
