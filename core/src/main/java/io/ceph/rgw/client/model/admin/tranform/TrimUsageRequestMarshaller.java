...
import io.ceph.rgw.client.model.admin.TrimUsageRequest;
 ...
 */
public class TrimUsageRequestMarshaller extends AdminRequestMarshaller<TrimUsageRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().requestUri("/admin/usage?format=xml")
    ...
    public TrimUsageRequestMarshaller(AwsXmlProtocolFactory protocolFactory) {
