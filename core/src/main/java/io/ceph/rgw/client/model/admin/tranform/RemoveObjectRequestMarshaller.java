...
import io.ceph.rgw.client.model.admin.RemoveObjectRequest;
 ...
 */
public class RemoveObjectRequestMarshaller extends AdminRequestMarshaller<RemoveObjectRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().requestUri("/admin/bucket?object&format=xml")
    ...
    public RemoveObjectRequestMarshaller(AwsXmlProtocolFactory protocolFactory) {
